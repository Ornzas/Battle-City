...
void PlayerTank::handleInput(float dt, const Map& map, const sf::Vector2f& mapOffset) {
...
void PlayerTank::update(float dt, const Map& map, const sf::Vector2f& mapOffset) {
